...
class ProductSizesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_size" do
    assert_difference('ProductSize.count') do
      post product_sizes_url, params: { product_size: { product_size_name: @product_size.product_size_name, shop_name: @product_size.shop_name } }
    end
  ...
  test "should update product_size" do
    patch product_size_url(@product_size), params: { product_size: { product_size_name: @product_size.product_size_name, shop_name: @product_size.shop_name } }
